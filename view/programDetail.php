        ...
        <div class="row details-form">
            <div class="container container-details"><label><strong>Actions</strong><br /></label>
                <div id="buttondetail" class="row">
                    ...
                    <div class="col-sm-6"><button class="btn btn-secondary btn-block" onclick="location.href='<?php echo $GLOBALS["ROOT_URL"]; ?>/program/pdf/<?php echo $program->getId(); ?>'" type="button">Generate PDF</button></div>
                </div>
            </div>
        </div>
        <div class="row details-form">
